...
public class SortAdapter extends RecyclerView.Adapter<SortAdapter.ViewHolder> {
    ...
    private List<NationCodeModel> mData;
    ...
    public SortAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.nation_code_sort_item, parent, false);
        ViewHolder viewHolder = new ViewHolder(view);
        viewHolder.tvName = view.findViewById(R.id.tvName);
        viewHolder.tvNationCode = view.findViewById(R.id.tvNationCode);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(final SortAdapter.ViewHolder holder, final int position) {
        ...
        holder.tvNationCode.setText("+" + mData.get(position).getCode());
        holder.tvName.setText(this.mData.get(position).getContry());
    }
     ...
     * @param list
     */
    public void updateList(List<NationCodeModel> list) {
