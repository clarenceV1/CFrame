...
public class ShareWechatManager {

    public static void shareWechatForProtocol(final Context context, final WebProtocolDO protocolDO, final IWebProtocolCallback callback) {
        ...
        shareWechat(protocolDO.getParams(), new PlatformActionListener() {
            @Override
    ...
    public static void shareWechat(String parama, PlatformActionListener shareCallback) {
